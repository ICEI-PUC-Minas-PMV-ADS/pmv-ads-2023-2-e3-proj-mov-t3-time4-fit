...
function RefeicoesList({refeicoes, refeicoesDiarias, data, isVisitor = false}) {
    return (
        <View style={styles.container}>
            {refeicoes.map((refeicao) => {
                ...
                return <RefeicaoItem key={refeicao.id} {...refeicao} calorias={calorias} data={data} hideAddButton={isVisitor}/>
            })}
        </View>
    )
}
